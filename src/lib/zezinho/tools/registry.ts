...
export const TOOL_REGISTRY: Record<ToolId, ToolDefinition> = {
  ...
  stone_divergences_summary: {
    id: "stone_divergences_summary",
    label: "Resumo de divergências Stone × JumpPark já identificadas (persistidas)",
    source: "Stone × JumpPark (histórico persistido)",
    reuses: "buildDivergencesSummary (src/lib/integrations/stone/divergencesSummary.ts)",
    objectives: ["improve_cash_flow", "business_health"],
    requiresPeriod: false,
    costHint: "low",
    relevance: "medium",
  ...
  stone_integration_health: {
    id: "stone_integration_health",
    label: "Status e saúde da integração Stone Conciliação",
    source: "Stone — Conciliação Cliente Stone (histórico de importação)",
    reuses: "getStoneIntegrationHealth (src/lib/integrations/stone/healthStatus.ts)",
    objectives: ["improve_cash_flow", "business_health"],
    requiresPeriod: false,
    costHint: "low",
    relevance: "low",
